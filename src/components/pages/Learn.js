            ...
            <div class="row learn-row-main">
                    ...
                    <ul class="row media-list main-list">
                        {this.state.articles.map(({author, title, url, urlToImage }) => {
                            return (
                                <li className="col-lg-3 col-md-3 col-sm-3 learn" style={{borderStyle:"solid", borderColor:"#4183D7", backgroundColor:"#e8e8e8", borderWidth:"1px", padding:"5px", margin:"2px"}}>
